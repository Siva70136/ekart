...
const Login = (props) => {
    ...
    const login = async (e) => {
        ...
        try {
            const response = await fetch('https://ekart-t7sz.onrender.com/api/client/login', options);
    ...
    const register = async (e) => {
       ...
       // console.log(formData)
        ...
        try {
            const response = await fetch('https://ekart-t7sz.onrender.com/api/client/register', options);
            const data = await response.json();
            console.log(data);
        } catch (error) {
            console.error('An error occurred:', error);
